...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("images/homelander.png"));
        Image i5 = i4.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel profile = new JLabel(i6);
        profile.setBounds(-10, -40, 150, 150);
        p1.add(profile);
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("images/menu.png"));
        ...
        JLabel name = new JLabel("Homelander");
        name.setBounds(100, 15, 110, 22);
